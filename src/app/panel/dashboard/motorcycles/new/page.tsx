...
export default function NewMotorcyclePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) {
        alert("Error creating motorcycle: " + error.message);
        setLoading(false);
        return;
      }
  ...
  return (
    <div>
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-bold text-white">Add New Motorcycle</h1>
          <p className="text-slate-400 mt-1">Create a new motorcycle listing</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="max-w-4xl">
        <div className="bg-slate-800 border border-slate-700 rounded-xl p-6 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="md:col-span-2">
              ...
              <input
                ...
                placeholder="e.g., Luxury Motorcycle 2023"
                required
              />
            </div>
          ...
          <div className="flex items-center gap-4 pt-6 border-t border-slate-700">
            ...
            >
              {uploading ? "Uploading Images..." : loading ? "Creating..." : "Create Motorcycle"}
            </button>
            <Link
              href="/panel/dashboard/motorcycles"
