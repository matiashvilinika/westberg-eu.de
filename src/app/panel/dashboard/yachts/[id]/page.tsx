...
export default function EditYachtPage() {
  ...
  useEffect(() => {
    const fetchYacht = async () => {
      ...
      if (error) {
        alert("Error loading yacht: " + error.message);
  ...
  return (
    <div>
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-bold text-white">Edit Yacht</h1>
          <p className="text-slate-400 mt-1">Update yacht listing details</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="max-w-4xl">
        <div className="bg-slate-800 border border-slate-700 rounded-xl p-6 space-y-6">
          ...
          <div className="flex items-center gap-4 pt-6 border-t border-slate-700">
            ...
            >
              {uploading ? "Uploading Images..." : saving ? "Updating..." : "Update Yacht"}
            </button>
            <Link
              href="/panel/dashboard/yachts"
